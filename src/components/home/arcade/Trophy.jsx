/* ══════════════════════════════════════════════════
   Cups for the top three.

   Drawn rather than typed: an emoji trophy renders as
   whatever the viewer's platform ships, which on some
   machines is a flat brown blob and on others a full
   colour illustration at a size nothing else on the
   page matches. These are the same shape at all three
   placings and differ only in metal.

   The four-stop gradient plus the highlight down the
   left of the bowl is the whole trick — two stops read
   as plastic, four read as something polished.
   ══════════════════════════════════════════════════ */
...
export default function Trophy({ place }) {
  ...
  return (
    ...
    >
      ...
      {/* bowl, then the shine down its left side */}
